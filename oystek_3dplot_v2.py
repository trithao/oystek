...
#===========================================
radius = 135.2
num_plots = 5       # first n oysters with individual view plots
num_plots_AiO = 5 # first n oyster with 4-in-1 view plot
num_samples = 500000
...
def point_on_contour(xy,z,i):
  ...
  y = xy[1]
  if i==0:
    return (oyster_images[0][z][x+n_cols/2] == '#')  and is_on_contour(0,z,x+n_cols/2)
  elif i==2:
    return ((oyster_images[2][z][-y+n_cols/2] == '#')  and is_on_contour(2,z,-y+n_cols/2))
  elif i==1:
    return (oyster_images[1][z][-x+n_cols/2] == '#')  and is_on_contour(1,z,-x+n_cols/2)
  elif i==3:
    return (oyster_images[3][z][-y+n_cols/2] == '#') and  is_on_contour(3,z,-y+n_cols/2)
  return False
...
oystek_start(u"28Mar13\\147mm x10 2013-Mar-28.log")
